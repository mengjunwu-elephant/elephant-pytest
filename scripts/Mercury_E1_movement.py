...
# 初始化机械臂
mc = MercuryE1('com11',debug=1)

# 各关节的极限位置
joints = {
    'j1': {'min': [-155, 0, 0, 0, 0, 10, 0], 'max': [155, 0, 0, 0, 10, 0, -45]},
    'j2': {'min': [0, -55, 90, 0, 0, 10, 90], 'max': [0, 105, -90, 0, 10, 0, 0]},
    'j3': {'min': [10, 0, -160, 0, -90, 0, 0], 'max': [-10, 0, 160, 0, 90, 0, -90]},
    'j4': {'min': [10, 0, 0, -135, -90, 0, 30], 'max': [-10, 0, 0, 18, 0, 0, 0]},
    'j5': {'min': [30, 0, 0, 0, -160, -10, 40], 'max': [-20, 0, 0, 0, 160, 30, 20]},
    'j6': {'min': [0, 30, 0, 0, 0, -100, 0], 'max': [0, -20, 0, 0, 0, 117, 0]},
    'j7': {'min': [0, 30, 0, 0, 0, 0, -135], 'max': [0, -20, 0, 0, 0, 117, 135]},
}
