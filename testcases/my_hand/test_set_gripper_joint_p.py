...
# 从Excel中提取数据
cases = get_test_data_from_excel(MyHandBase.TEST_DATA_FILE, "set_gripper_joint_p")
...
def test_set_gripper_joint_p(device, case):
    ...
    with allure.step(f"调用接口 set_gripper_joint_P，joint={case['joint']}，parameter={case['parameter']}"):
        ...
        get_res = device.m.get_gripper_joint_P(case["joint"])
