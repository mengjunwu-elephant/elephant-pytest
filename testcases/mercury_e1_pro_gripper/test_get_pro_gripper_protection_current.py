...
cases = get_test_data_from_excel(MercuryE1Base.PRO_GRIPPER_TEST_DATA_FILE, "get_protection_current")
...
def test_get_protection_current(device, case):
    title = case["title"]
    ...
    with allure.step("调用接口 get_pro_gripper_protection_current 获取保护电流"):
        response = device.mc.get_pro_gripper_protection_current()
