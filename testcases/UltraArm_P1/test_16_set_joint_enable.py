...
# 从 Excel 读取测试数据
cases = get_test_data_from_excel(UltraArmP1Base.TEST_DATA_FILE, "set_joint_enable")
...
@allure.feature("设置机械臂上使能")
@allure.story("正确获取机械臂上使能")
@pytest.mark.parametrize("case", [c for c in cases if c["test_type"] == "normal"], ids=lambda c: c["title"])
def test_set_joint_enable(device, case):
    title = case["title"]
