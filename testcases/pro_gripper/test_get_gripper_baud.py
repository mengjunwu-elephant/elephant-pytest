...
# 加载测试数据
cases = get_test_data_from_excel(ProGripperBase.TEST_DATA_FILE, "get_gripper_baud")
...
def test_get_gripper_baud(device, case):
    ...
    with allure.step("打印测试参数信息"):
        ...
        logger.debug(f'test_baud: {case.get("baud", "")}')

    with allure.step("调用 get_gripper_baud 接口获取波特率"):
