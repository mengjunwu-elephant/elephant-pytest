...
# 获取测试数据
cases = get_test_data_from_excel(ProGripperBase.TEST_DATA_FILE, "get_open_angle")
...
def test_get_open_angle(device, case):
    ...
    with allure.step("调用接口 get_gripper_io_open_value 获取张开角度"):
        response = device.m.get_gripper_io_open_value()
