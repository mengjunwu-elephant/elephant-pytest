...
# 获取测试数据
cases = get_test_data_from_excel(ProGripperBase.TEST_DATA_FILE, "get_protection_current")
...
def test_get_protection_current(device, case):
    ...
    with allure.step("调用接口 get_gripper_protection_current 获取保护电流"):
        response = device.m.get_gripper_protection_current()
