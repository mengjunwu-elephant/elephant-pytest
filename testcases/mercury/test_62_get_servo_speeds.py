...
def test_get_servo_speeds_normal(device, case):
    ...
    with allure.step("获取左臂舵机速度"):
        l_response = device.ml.get_servo_speeds()

    with allure.step("获取右臂舵机速度"):
        r_response = device.mr.get_servo_speeds()
