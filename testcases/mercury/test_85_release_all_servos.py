...
# 从 Excel 读取测试数据
cases = get_test_data_from_excel(MercuryBase.TEST_DATA_FILE, "release_all_servos")
...
@allure.feature("所有电机掉电")
@allure.story("正确所有电机掉电")
