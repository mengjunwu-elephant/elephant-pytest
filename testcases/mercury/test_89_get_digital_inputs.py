...
# 从 Excel 读取测试数据
cases = get_test_data_from_excel(MercuryBase.TEST_DATA_FILE, "get_digital_inputs")
...
@allure.feature("读取末端所有引脚状态")
@allure.story("正确读取末端所有引脚状态")
@pytest.mark.parametrize("case", [c for c in cases if c["test_type"] == "normal"], ids=lambda c: c["title"])
def test_get_digital_inputs(device, case):
    title = case["title"]
