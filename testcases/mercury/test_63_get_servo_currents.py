...
def test_get_servo_currents_normal(device, case):
    ...
    with allure.step("获取左臂舵机电流"):
        l_response = device.ml.get_servo_currents()

    with allure.step("获取右臂舵机电流"):
        r_response = device.mr.get_servo_currents()
