...
import pytest
import allure
from pymycobot.error import MercuryDataException, MercuryE1DataException
...
# 从 Excel 中加载用例
cases = get_test_data_from_excel(MercuryE1Base.TEST_DATA_FILE, "set_color")
...
def test_set_color_exception(device, case):
    ...
    with allure.step("断言设置非法颜色值抛出 MercuryE1DataException"):
