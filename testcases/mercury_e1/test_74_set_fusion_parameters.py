...
# 从 Excel 读取测试数据
cases = get_test_data_from_excel(MercuryE1Base.TEST_DATA_FILE, "set_fusion_parameters")
...
def test_set_tool_serial_timeout_exception(device, case):
    ...
    with allure.step(f"断言抛出 MercuryE1DataException,参数为{case['rank']}，值为{case['value']}"):
