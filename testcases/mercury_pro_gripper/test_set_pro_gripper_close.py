...
# 从 Excel 中提取测试数据
cases = get_test_data_from_excel(MercuryBase.PRO_GRIPPER_TEST_DATA_FILE, "set_pro_gripper_close")


@pytest.fixture(scope="module")
def device():
    dev = MercuryBase()
    dev.ml.set_pro_gripper_open()
