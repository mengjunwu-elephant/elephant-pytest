...
cases = get_test_data_from_excel(Mycobot450Base.PRO_GRIPPER_TEST_DATA_FILE, "get_pro_gripper_io_close_angle")
...
def test_get_close_angle(device, case):
    ...
    with allure.step(f"调用接口 get_pro_gripper_io_close_angle 获取夹爪闭合角度"):
        response = device.mc.get_pro_gripper_io_close_angle()
