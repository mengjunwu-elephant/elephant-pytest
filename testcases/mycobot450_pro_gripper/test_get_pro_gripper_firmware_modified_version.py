...
cases = get_test_data_from_excel(Mycobot450Base.PRO_GRIPPER_TEST_DATA_FILE, "get_modified_version")
...
def test_get_pro_gripper_firmware_modified_version(device, case):
    title = case["title"]
    ...
    with allure.step("调用接口 get_pro_gripper_firmware_modified_version 获取版本号"):
        response = device.mc.get_pro_gripper_firmware_modified_version()
