...
cases = get_test_data_from_excel(Mycobot450Base.PRO_GRIPPER_TEST_DATA_FILE, "get_pro_gripper_mini_pressure")
...
def test_get_gripper_min_pressure(device, case):
    ...
    with allure.step("调用接口 get_pro_gripper_mini_pressure 获取夹爪最小压力"):
        response = device.mc.get_pro_gripper_mini_pressure()
