...
# 从 Excel 中提取测试数据
cases = get_test_data_from_excel(Mycobot320Base.GRIPPER_TEST_DATA_FILE, "set_pro_gripper_open")
...
def test_set_pro_gripper_open(device, case):
    ...
    with allure.step("调用 set_pro_gripper_open 接口"):
        response = device.m.set_pro_gripper_open()
